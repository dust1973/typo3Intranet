...
class UserRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	public function findUser($filter) {
		$sql = " SELECT uid, pid, username, disable, first_name as firstName , last_name as lastName, email, 	FROM_UNIXTIME(crdate) as crdate
             FROM fe_users
            ORDER BY " . $filter['field'] . " " . $filter['sorting'] ;
		$query = $this->createQuery();
