<?php
namespace Woehrl\ListeFeUsers\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Woehrl\ListeFeUsers\Controller\UserController.
 *
...
class UserControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Woehrl\ListeFeUsers\Controller\UserController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Woehrl\\ListeFeUsers\\Controller\\UserController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllUsersFromRepositoryAndAssignsThemToView() {
		...
		$userRepository = $this->getMock('Woehrl\\ListeFeUsers\\Domain\\Repository\\UserRepository', array('findAll'), array(), '', FALSE);
