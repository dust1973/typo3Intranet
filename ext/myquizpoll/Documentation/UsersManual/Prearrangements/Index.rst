...
1. Install the extension using the Extension Manager.2. Create a
standard-page.3. Create a pagecontent and choose the type “Insert
plugin”. Choose the plugin “My Quiz and Poll”.You can although use the
pagecontent-wizard:
