...
*  Copyright notice
*
*  (c) 2010 Kurt Gusbeth <info@myquizandpoll.de>
*  All rights reserved
*
 ...
 */
class tx_myquizpoll_pi1_wizicon {
	...
	function proc($wizardItems)	{
		...
		$wizardItems['plugins_tx_myquizpoll_pi1'] = array(
			'icon'=>t3lib_extMgm::extRelPath('myquizpoll').'pi1/ce_wiz.gif',
			'title'=>$LANG->getLLL('pi1_title',$LL),
			'description'=>$LANG->getLLL('pi1_plus_wiz_description',$LL),
			'params'=>'&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=myquizpoll_pi1'
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/myquizpoll/pi1/class.tx_myquizpoll_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/myquizpoll/pi1/class.tx_myquizpoll_pi1_wizicon.php']);
}
