<?php
  ...
  $qtuid = intval(t3lib_div::_GP('qtid'));	// quiz taker
  $uid = intval(t3lib_div::_GP('qid'));		// question
  ...
  $joker3 = intval(t3lib_div::_GP('joker3'));
  $vote = t3lib_div::_GP('vote');			// selected answer(s)
  $antworten = intval(t3lib_div::_GP('qnr'));
