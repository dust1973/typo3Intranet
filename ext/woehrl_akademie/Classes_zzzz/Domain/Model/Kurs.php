...
class Kurs extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	 ...
	 * Teilnehmer
	 * 
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer>
	 */
	 ...
	 * Dozent
	 * 
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Dozent>
	 */
	protected $dozent = NULL;
	...
	protected function initStorageObjects() {
		...
		$this->teilnehmer = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
		$this->dozent = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
	}
	 ...
	 * Adds a Teilnehmer
	 * 
	 * @param \Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer $teilnehmer
	 * @return void
	 */
	public function addTeilnehmer(\Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer $teilnehmer) {
		$this->teilnehmer->attach($teilnehmer);
	}

	/**
	 * Removes a Teilnehmer
	 * 
	 * @param \Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer $teilnehmerToRemove The Teilnehmer to be removed
	 * @return void
	 */
	public function removeTeilnehmer(\Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer $teilnehmerToRemove) {
	 ...
	 * 
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer> $teilnehmer
	 */
	 ...
	 * Sets the teilnehmer
	 * 
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Teilnehmer> $teilnehmer
	 * @return void
	 */
	 ...
	 * @return void
	 */
	public function addDozent(\Woehrl\WoehrlAkademie\Domain\Model\Dozent $dozent) {
		$this->dozent->attach($dozent);
	}

	/**
	 * Removes a Dozent
	 * 
	 * @param \Woehrl\WoehrlAkademie\Domain\Model\Dozent $dozentToRemove The Dozent to be removed
	 * @return void
	 */
	public function removeDozent(\Woehrl\WoehrlAkademie\Domain\Model\Dozent $dozentToRemove) {
		$this->dozent->detach($dozentToRemove);
	}

	/**
	 * Returns the dozent
	 * 
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Dozent> $dozent
	 */
	 ...
	 * Sets the dozent
	 * 
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Woehrl\WoehrlAkademie\Domain\Model\Dozent> $dozent
	 * @return void
	 */
	public function setDozent(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $dozent) {
		$this->dozent = $dozent;
	}
