...
/**
 * Test case for class \Woehrl\WoehrlAkademie\Domain\Model\Kategorie.
 *
...
class KategorieTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Woehrl\WoehrlAkademie\Domain\Model\Kategorie
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Woehrl\WoehrlAkademie\Domain\Model\Kategorie();
	}
