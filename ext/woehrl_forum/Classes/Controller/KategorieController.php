...
class KategorieController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	 ...
	 * kategorieRepository
	 * 
	 * @var \Woehrl\WoehrlForum\Domain\Repository\KategorieRepository
	 * @inject
	 */
	 ...
	 * @return void
	 */
	public function showAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $kategorie) {
	 ...
	 * action new
	 * 
	 * @param \Woehrl\WoehrlForum\Domain\Model\Kategorie $newKategorie
	 * @ignorevalidation $newKategorie
	 * @return void
	 */
	public function newAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $newKategorie = NULL) {
	 ...
	 * @return void
	 */
	public function createAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $newKategorie) {
	 ...
	 * @return void
	 */
	public function editAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $kategorie) {
		$this->view->assign('kategorie', $kategorie);
	}
	 ...
	 * @return void
	 */
	public function updateAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $kategorie) {
	 ...
	 * @return void
	 */
	public function deleteAction(\Woehrl\WoehrlForum\Domain\Model\Kategorie $kategorie) {
