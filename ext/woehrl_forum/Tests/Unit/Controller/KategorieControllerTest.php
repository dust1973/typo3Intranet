...
/**
 * Test case for class Woehrl\WoehrlForum\Controller\KategorieController.
 *
...
class KategorieControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Woehrl\WoehrlForum\Controller\KategorieController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Woehrl\\WoehrlForum\\Controller\\KategorieController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllKategoriesFromRepositoryAndAssignsThemToView() {
		...
		$kategorieRepository = $this->getMock('Woehrl\\WoehrlForum\\Domain\\Repository\\KategorieRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenKategorieToKategorieRepository() {
		...
		$kategorieRepository = $this->getMock('Woehrl\\WoehrlForum\\Domain\\Repository\\KategorieRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenKategorieInKategorieRepository() {
		...
		$kategorieRepository = $this->getMock('Woehrl\\WoehrlForum\\Domain\\Repository\\KategorieRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenKategorieFromKategorieRepository() {
		...
		$kategorieRepository = $this->getMock('Woehrl\\WoehrlForum\\Domain\\Repository\\KategorieRepository', array('remove'), array(), '', FALSE);
