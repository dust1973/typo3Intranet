...
namespace Woehrl\WoehrlLoginstatus\Tests\Unit\Domain\Model;
...
/**
 * Test case for class \Woehrl\WoehrlLoginstatus\Domain\Model\Status.
 *
...
class StatusTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Woehrl\WoehrlLoginstatus\Domain\Model\Status
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Woehrl\WoehrlLoginstatus\Domain\Model\Status();
	}
