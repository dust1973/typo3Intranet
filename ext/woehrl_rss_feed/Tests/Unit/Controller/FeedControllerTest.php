<?php
namespace WOEHRL\WoehrlRssFeed\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class WOEHRL\WoehrlRssFeed\Controller\FeedController.
 *
...
class FeedControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \WOEHRL\WoehrlRssFeed\Controller\FeedController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('WOEHRL\\WoehrlRssFeed\\Controller\\FeedController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllFeedsFromRepositoryAndAssignsThemToView() {
		...
		$feedRepository = $this->getMock('', array('findAll'), array(), '', FALSE);
