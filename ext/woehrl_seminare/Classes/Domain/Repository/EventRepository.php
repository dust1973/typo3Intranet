 ...
 *
 */
class Tx_WoehrlSeminare_Domain_Repository_EventRepository extends Tx_Extbase_Persistence_Repository {
	...
	public function findAllByDisciplineAndCategory($discipline, $category) {
		...
		$constraints = array();
		//~ $constraints[] = $query->in('tx_woehrlseminare_domain_model_category.uid', $categories);
