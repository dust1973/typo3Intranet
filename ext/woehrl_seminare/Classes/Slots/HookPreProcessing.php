 ...
 */
class Tx_WoehrlSeminare_Slots_HookPreProcessing {
	...
	function processDatamap_preProcessFieldArray(&$fieldArray, $table, $id, &$pObj) {
		...
		if ($table == 'tx_woehrlseminare_domain_model_event') { // prevent moving of categories into their rootline
			...
			if ($fieldArray['genius_bar'] === FALSE)
				...
				$message_text = 'Veranstaltung gespeichert: ';
