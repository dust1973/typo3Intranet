...
class Tx_WoehrlSeminare_Slots_ValidationController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function initializeAction() {
		$this->subscriberRepository = t3lib_div::makeInstance('Tx_WoehrlSeminare_Domain_Repository_SubscriberRepository');
		$this->formsRepository = t3lib_div::makeInstance('Tx_Powermail_Domain_Repository_FormsRepository');
		$this->eventRepository = t3lib_div::makeInstance('Tx_WoehrlSeminare_Domain_Repository_EventRepository');
	}
