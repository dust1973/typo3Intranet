...
class Tx_WoehrlSeminare_ViewHelpers_Condition_HasSubcategoriesViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	 ...
	 *
	 * @param Tx_WoehrlSeminare_Domain_Repository_CategoryRepository $categoryRepository
	 * @return void
	 */
	public function injectCategoryRepository(Tx_WoehrlSeminare_Domain_Repository_CategoryRepository $categoryRepository) {
