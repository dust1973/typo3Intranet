 ...
 * @scope prototype
 */
class Tx_WoehrlSeminare_ViewHelpers_Format_Fullcalendar_JsFooterViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
		...
		// get field configuration
			...
			$js1 .= "events: {
					...
					data: function() {
						var eventurl = '';
						var disurl = '';
						$('.woehrlseminare-category input:checked').each(function() {
							var cal = $(this).attr('id').split(\"-\")[2];
							eventurl = eventurl + ',' + cal;
						});
						$('.woehrlseminare-discipline input:checked').each(function() {
							var cal = $(this).attr('id').split(\"-\")[2];
							disurl = disurl + ',' + cal;
						});
						return {
