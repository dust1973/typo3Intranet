...
/**
 * Test case for class Tx_WoehrlSeminare_Domain_Model_Category.
 *
 * @version $Id$
 ...
 */
class Tx_WoehrlSeminare_Domain_Model_CategoryTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_WoehrlSeminare_Domain_Model_Category
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_WoehrlSeminare_Domain_Model_Category();
	}
	 ...
	 * @test
	 */
	public function getParentReturnsInitialValueForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_Category() {
	 ...
	 * @test
	 */
	public function setParentForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_CategorySetsParent() {
