...
/**
 * Test case for class Tx_WoehrlSeminare_Domain_Model_Event.
 *
 * @version $Id$
 ...
 *
 * @package TYPO3
 * @subpackage WÖHRL Akademie |  Seminare
 *
 * @author Alexander Fuchs <alexander.fuchs@woehrl.de>
 */
class Tx_WoehrlSeminare_Domain_Model_EventTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_WoehrlSeminare_Domain_Model_Event();
	}
	 ...
	 * @test
	 */
	public function getCategoriesReturnsInitialValueForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_Category() {
	 ...
	 * @test
	 */
	public function getSubscribersReturnsInitialValueForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_Subscriber() {
		$newObjectStorage = new Tx_Extbase_Persistence_ObjectStorage();
		$this->assertEquals(
			$newObjectStorage,
	 ...
	 * @test
	 */
	public function setSubscribersForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_SubscriberSetsSubscribers() {
	 ...
	 * @test
	 */
	public function getLocationReturnsInitialValueForTx_WoehrlSeminare_Domain_Model_Location() { }

	/**
	 * @test
	 */
	public function setLocationForTx_WoehrlSeminare_Domain_Model_LocationSetsLocation() { }
	
	/**
	 * @test
	 */
	public function getDisciplineReturnsInitialValueForTx_WoehrlSeminare_Domain_Model_Discipline() { }

	/**
	 * @test
	 */
	public function setDisciplineForTx_WoehrlSeminare_Domain_Model_DisciplineSetsDiscipline() { }
	
	/**
	 * @test
	 */
	public function getContactReturnsInitialValueForTx_WoehrlSeminare_Domain_Model_Contact() { }

	/**
	 * @test
	 */
	public function setContactForTx_WoehrlSeminare_Domain_Model_ContactSetsContact() { }
