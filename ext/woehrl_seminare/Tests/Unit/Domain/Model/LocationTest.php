...
/**
 * Test case for class Tx_WoehrlSeminare_Domain_Model_Location.
 *
 * @version $Id$
 ...
 */
class Tx_WoehrlSeminare_Domain_Model_LocationTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_WoehrlSeminare_Domain_Model_Location();
	}
	 ...
	 * @test
	 */
	public function getParentReturnsInitialValueForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_Location() {
	 ...
	 * @test
	 */
	public function setParentForObjectStorageContainingTx_WoehrlSeminare_Domain_Model_LocationSetsParent() {
