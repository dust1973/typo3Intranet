...
/**
 * Test case for class Tx_WoehrlSeminare_Domain_Model_Subscriber.
 *
 * @version $Id$
 ...
 */
class Tx_WoehrlSeminare_Domain_Model_SubscriberTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_WoehrlSeminare_Domain_Model_Subscriber
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_WoehrlSeminare_Domain_Model_Subscriber();
	}
	 ...
	 * @test
	 */
	public function getEventReturnsInitialValueForTx_WoehrlSeminare_Domain_Model_Event() { }

	/**
	 * @test
	 */
	public function setEventForTx_WoehrlSeminare_Domain_Model_EventSetsEvent() { }
